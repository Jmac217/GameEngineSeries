...
namespace Hazel {
	...
	void OpenGLRendererAPI::DrawIndexed(const Ref<VertexArray>& vertexArray, uint32_t indexCout)
	{
		uint32_t count = indexCout ? vertexArray->GetIndexBuffer()->GetCount() : indexCout;
